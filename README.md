...
csv logger: root@e716608d2a22:/ros2_ws/microampere_ros2ws# python3 csv_logger_node.py --output-dir src/microamp_fgo_rov_tracking/post_processing/debugging/test --run-name my_experiment_0
...
```
cd existing_repo
git remote add origin https://turlab.itk.ntnu.no/turlab/bsc_msc_students/microamp_fgo_rov_tracking.git
git branch -M main
